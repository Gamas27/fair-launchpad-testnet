...
const mockTokenTemplates = [
  {
    id: 1,
    name: 'Meme Coin',
    description: 'Classic meme token with viral potential',
    icon: '🐸',
    features: ['Viral Marketing', 'Community Driven', 'High Volatility'],
    popularity: 95
  },
  {
    id: 2,
    name: 'Utility Token',
    description: 'Functional token with real-world use cases',
    icon: '⚙️',
    features: ['Real Utility', 'Stable Growth', 'Long-term Value'],
    popularity: 78
  },
  {
    id: 3,
    name: 'GameFi Token',
    description: 'Gaming-focused token with play-to-earn mechanics',
    icon: '🎮',
    features: ['Gaming Integration', 'Play-to-Earn', 'NFT Support'],
    popularity: 88
  }
]

// Create Coin Module Component
export function CreateCoinModule() {
  ...
  const handleFileUpload = (field: 'logo' | 'banner', file: File) => {
    ...
    reader.onload = (e) => {
      handleInputChange(field === 'logo' ? 'logoPreview' : 'bannerPreview', e.target?.result)
    }
            ...
            <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <label
                        htmlFor="logo-upload"
                        className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-500 to-pink-500 text-white rounded-lg cursor-pointer hover:from-cyan-600 hover:to-pink-600 transition-colors"
                      >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-32 h-16 rounded-lg bg-gradient-to-br from-purple-500 to-cyan-400 flex items-center justify-center border-2 border-gray-800/50">
                      {formData.bannerPreview ? (
                        <img src={formData.bannerPreview} alt="Banner preview" className="w-full h-full rounded-lg object-cover" />
                      ) : (
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Market Cap Target (SOL)</label>
                  <input
                    type="number"
                    value={formData.marketCapTarget}
                    onChange={(e) => handleInputChange('marketCapTarget', e.target.value)}
                    placeholder="1000"
                    className="w-full px-3 py-2 bg-gray-900/50 border border-gray-800/50 rounded-lg text-white placeholder-gray-400 focus:border-cyan-400 focus:outline-none"
                  />
                </div>
...
export const CreateCoinModuleV1 = {
  version: 'v1.0.0',
  CreateCoinModule
}
