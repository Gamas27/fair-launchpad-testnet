...
// Profile/Wallet Module Component
        ...
        <div className="grid grid-cols-2 gap-3">
          <Card className="card-gradient border-2 border-cyan-400/50">
            <CardContent className="p-3 text-center">
              <div className="text-2xl font-bold text-cyan-400">#{mockUser.repScore}</div>
              <div className="text-xs text-gray-400">REP Ranking</div>
            </CardContent>
          </Card>
          <Card className="card-gradient border-2 border-pink-400/50">
            <CardContent className="p-3 text-center">
