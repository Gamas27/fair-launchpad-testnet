...
const mockToken = {
  ...
  description: 'Community-driven GameFi platform for arcade enthusiasts. Built by gamers, for gamers. Join the revolution of decentralized gaming.',
  logo: '🎮',
  marketCap: '$1.2B',
  price: '$0.045',
  change: '+5.25%',
  ...
  social: {
    ...
    website: 'arcadecoin.io'
  },
  team: [
    { name: 'Alex Chen', role: 'Founder', avatar: '👨‍💻' },
    { name: 'Sarah Kim', role: 'CTO', avatar: '👩‍💻' },
    { name: 'Mike Johnson', role: 'Game Dev', avatar: '👨‍🎮' }
  ],
  repBreakdown: {
    verified: 85,
    anon: 10,
  ...
  chartData: [0, 92.59, 74.07, 100, 55.56, 37.04, 62.96, 0]
}

// Coin Profile Module Component
export function CoinProfileModule() {
          ...
          <CardContent className="p-4">
            ...
            <div className="w-full h-16 mb-4">
              <svg viewBox="0 0 100 100" className="w-full h-full">
                <polyline
                  points={mockToken.chartData.map((value, index) => `${index * 14.28},${100 - value}`).join(' ')}
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
        ...
        {activeTab === 'overview' && (
          <div className="space-y-4">
            ...
            <Card className="card-gradient border-2 border-purple-400/50">
              ...
              <CardContent className="space-y-3">
                {mockToken.team.map((member, index) => (
                  <div key={index} className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-cyan-400 flex items-center justify-center text-sm">
                      {member.avatar}
                    </div>
                    <div>
          ...
          <div className="space-y-4">
            ...
            <Card className="card-gradient border-2 border-cyan-400/50">
              ...
              <CardContent className="space-y-3">
                ...
                <Button variant="outline" className="w-full justify-start border-green-400 text-green-400 hover:bg-green-400/10">
                  <ExternalLink className="h-4 w-4 mr-2" />
                  {mockToken.social.website}
                </Button>
              </CardContent>
            </Card>
...
export const CoinProfileModuleV1 = {
  version: 'v1.0.0',
  CoinProfileModule
}
