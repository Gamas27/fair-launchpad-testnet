...
// Simplified mock chat data for World App
const mockChats = {
  all: [
    {
      id: 1,
...
// World App Chat Module
export function ChatModuleWorldApp() {
...
export const ChatModuleWorldAppExport = {
  version: 'v1.0.0',
  ChatModule: ChatModuleWorldApp
}
