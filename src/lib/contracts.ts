...
export const CONTRACT_ADDRESSES = {
  GRADUATION_HANDLER: process.env.NEXT_PUBLIC_GRADUATION_HANDLER_ADDRESS || '0x0000000000000000000000000000000000000000',
  TOKEN_FACTORY: process.env.NEXT_PUBLIC_TOKEN_FACTORY_ADDRESS || '0x0000000000000000000000000000000000000000',
