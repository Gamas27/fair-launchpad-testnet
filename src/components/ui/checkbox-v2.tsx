...
const checkboxVariants = cva(
  'inline-flex items-center justify-center rounded border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black disabled:opacity-50 disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
...
const CheckboxV2 = React.forwardRef<HTMLInputElement, CheckboxV2Props>(
  ({
    className,
    variant,
    size,
...
export { CheckboxV2, checkboxVariants }
